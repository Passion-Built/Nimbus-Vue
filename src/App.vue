<template>
  ...
  <NuiBox
    ...
    <NuiHeading as="h1">testing h1</NuiHeading>
    <NuiHeading as="h2">testing h2</NuiHeading>
    <NuiHeading as="h3">testing h3</NuiHeading>
    ...
    <NuiInput
      ...
      isInvalid
      type="text"
      errorMessage="this value is empty"
    />
    <NuiInput
      leftIcon
      v-model="testInputNumber"
